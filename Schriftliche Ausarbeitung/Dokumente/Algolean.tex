\section{Algolean}\label{Algolean}\todo{section Algolean}
...
Der Grund, warum dieses Framework überhaupt benötigt wird und man nicht einfach eine Funktion definieren kann,\todo{satz aufteilen}
...
ist, dass Lean zwischen intentional\todo{kurz erklären} verschiedenen Funktionen, die beim Ausführen komplett unterschiedliche Dinge tun, keinen Unterschied sieht,
...
Jede grundliegende Funktion, bekommt dabei einen eigenen Konstruktor und hat als Typ die Query angewendet auf den Rückgabetyp der Funktion.
