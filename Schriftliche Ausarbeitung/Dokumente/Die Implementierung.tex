...
Danach habe ich direkt mit der nächsten Fallunterscheidung weiter gemacht, 
  ...
  then
    ...
    if h_rank_lt : uFLx.rank < uFLy.rank
      then
        ...
        have h_rank_succ_isLt : uFLx.rank.val.succ < nodeList.length := …
        ...
        if h_rank_lt' : uFLy.rank < uFLx.rank
          then
            -- Das selbe aber uFLx und uFLy vertauscht
          else
...
\KruskalupdateunionFindmatchingnodeId
% update_unionFind_matching_nodeId

\KruskalupdateunionFindmatchingccId
% update_unionFind_matching_ccId

\KruskalupdateunionFindmatchinglength
% update_unionFind_matching_length

\KruskalupdateunionFindnodup
